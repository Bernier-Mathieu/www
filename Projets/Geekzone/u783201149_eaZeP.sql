...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 04 jan. 2023 à 13:23
...
--
-- Base de données : `u783201149_eaZeP`
--
...
(1, '84 rte Beauvallon', '26000', 'VALENCE', 'valence.jpg', '04 75 56 27 77', 'Du lundi au samedi de 08h30 à 12h00 et de 14h00 à 19h00.'),
(2, '2 Bis av. St Roch', '38000', 'GRENOBLE', 'grenoble.jpg', '04 76 54 33 47', 'Du mardi au samedi de 8h30 à 19h30 (sans interruption) et le dimanche matin de 9h00 à 12h30.'),
(3, '7 Quai Célestins', '69002', 'LYON', 'lyon.jpg', '04 72 19 68 68', 'Ouvert 7j/7 de 8h30 à 20h30 (dimanche : 19h00).'),
(4, '35 r Jean Pierre Veyrat', '73000', 'CHAMBERY', 'chambery.jpg', '04 79 85 19 96', 'Du mardi au samedi de 8h30 à 19h30 (sans interruption) et le dimanche matin de 9h00 à 12h30.'),
(5, '32 rue Gambetta', '73200', 'ALBERTVILLE', 'albertville.jpg', '04 56 10 36 89', 'Du lundi au samedi de 08h30 à 12h00 et de 14h00 à 19h00.'),
(6, '46 av Genève', '74000', 'ANNECY', 'annecy.jpg', '04 50 57 01 13', 'Du mardi au samedi de 9h00 à 12h30 et de 14h30 à 19h30 et le dimanche de 9h00 à 12h30.'),
(7, '11 bis rue Saint-Esprit', '63000', 'CLERMONT FERRAND', 'clermont.jpeg', '09 83 70 11 98', 'Du mardi au samedi de 10h00 à 12h30 et de 13h30 à 19h00. ');
...
INSERT INTO `gérer` (`id_b`, `id_adb`) VALUES
(1, 5);
...
CREATE TABLE `User` (
  ...
  `statut` varchar(40) COLLATE utf8_unicode_ci NOT NULL,
  `id` int(100) NOT NULL
...
INSERT INTO `User` (`Username`, `mdp`, `nom`, `prenom`, `telephone`, `mail`, `ville`, `cp`, `adresse`, `statut`, `id`) VALUES
('math', '123', '', '', '', '', '', '', '', 'adming', 2),
('client', '123', '', '', '', '', '', '', '', 'client', 4),
('adminb', '123', '', '', '', '', '', '', '', 'adminb', 5),
('MB', '123456', 'Mathieu', 'Bernier', '0630749998', 'bernier.mathieu2001@gmail.com', 'Saclas', '91690', '7 Avenue Jean-Jaurès', 'client', 16),
('MTest', '$2y$10$wvS199YLjYyU9', 'Test', 'Mathieu', '0630749998', 'bernier.mathieu2001@gmail.com', 'Saclas', '91690', '7 Avenue Jean-Jaurès', 'client', 20);
...
--
ALTER TABLE `gérer`
  ADD CONSTRAINT `gérer_ibfk_1` FOREIGN KEY (`id_b`) REFERENCES `boutique` (`id`),
  ADD CONSTRAINT `gérer_ibfk_2` FOREIGN KEY (`id_adb`) REFERENCES `User` (`id`);
