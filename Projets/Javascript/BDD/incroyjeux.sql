...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 10 juin 2025 à 19:32
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `Insert_Score` (IN `Score` INT, IN `User` VARCHAR(200), IN `Gagner` BOOLEAN, IN `Game_Id` INT)   INSERT INTO 
`games_scores`(`Game_Id`, `User_Id`, `Game_Score`, `When_Play`, `Chrono_Time`) 
SELECT Game_Id , User_Id ,Score,NULL,NULL From users where Name = User$$
