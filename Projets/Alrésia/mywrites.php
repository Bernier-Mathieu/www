  ...
  <head>
    ...
    <?php   
        if(isset($_SESSION['login'])) {
            $id = $_SESSION['id'];
            echo '<p>Vos Notes :</p><br><p><a href="notes.php">Ajoutez des notes</a></p>';
            $db  = new PDO('mysql:host=localhost;dbname=u783201149_alresia;charset=utf8', 'root', '');
            
        $sqlQuery = 'SELECT * FROM Notes WHERE id_user = "'.$id.'"';
        ...
        foreach ($produit as $produit) {
         ...
         <p> '.$produit['note'].' </p>
         <a href="suppr.php?id='.$produit['id_notes'].'"><p>Supprimer</p></a>
         <a href="modifn.php?id='.$produit['id_notes'].'"><p>modifier</p></a><br><br><br>';
        }}else{
