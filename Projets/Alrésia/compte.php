...
<html>
  <head>
    ...
    <body>
        ...
        $sqlQuery = 'SELECT * FROM Utilisateurs WHERE pseudo = "'.$login.'"';
        ...
        foreach ($produit as $produit) {
         ...
         echo '<p id="name"> '.$produit['pseudo'].' </p>
               <img id="avatar" src="images/'.$produit['Avatar'].'"><br><br><br><br><br><br><br><br><br>
               <p id="des"> Informations sur moi : <br> '.$produit['Description'].'</p>
                        <br> <p><a href="profil.php">Ajoutez des informations</a></p>' ;
        }}else{
