...
?>
   ...
   <p id="left">
    <div id="container1">
     <form method="post" action="modifhsql.php" id="center">
      <label id=""><b>Titre</b></label><br>
      <input name="titre" value="'.$produit['titre'].'" required><br>
      <label id=""><b>texte</b></label><br>
      <textarea name="txt" rows="150" cols="150" required>'.$produit['texte'].'</textarea><br>
