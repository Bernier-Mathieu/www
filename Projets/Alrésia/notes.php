...
<html>
  <head>
   ...
   <p>
    <div id="container1">
     <form method="post" action="note.php" id="center">
      <h1 id="">Entrez les informations<h1>
      <label id=""><b>Titre</b></label><br>
      <input type="text" placeholder="Entrer le titre" name="titre" required><br>
      <label id=""><b>Notes</b></label><br>
      <textarea name="note" value="" placeholder="Entrez votre note"  rows="7" cols="20" required></textarea><br>
